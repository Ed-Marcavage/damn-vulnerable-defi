    ...
    Pausable
{
     ...
     */
    // check max flash loan amount to borrow
     ...
     * @inheritdoc IERC3156FlashLender
     */
    //the user determines the fee associated with the desired loan amount
    function flashFee(
        address _token,
        uint256 _amount
        ...
        // q - why if amount is less than maxFlashLoan, fee is 0?
     ...
     * @inheritdoc IERC3156FlashLender
     */
    // q - where is the fail if its not repaid?
    function flashLoan(
        ...
        // @audit - is there a way to not return all the assets?
        // @audit mis handling of eth
